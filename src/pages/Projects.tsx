...
const projects = [
  {
    ...
    bulletPoints: [
      ...
      "Conducted a mixed-method user needs assessment (n=15) using semi-structured interviews and clinical scales (BSMAS, GAD-7, PHQ-8), analyzed via PSPP ("Conducted a mixed-method user needs assessment (n=15) using semi-structured interviews and clinical scales (BSMAS, GAD-7, PHQ-8), analyzed via PSPP (Pearson correlations, t-tests) and NVivo (thematic coding) to develop targeted user personas",) and NVivo (thematic coding) to develop targeted user personas",
