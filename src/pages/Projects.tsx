...
const projects = [
  {
    ...
    bulletPoints: [
      ...
      "Proposed a hybrid model combining a faculty-based social prescriber with a supportive app, helping students navigate clubs, mental health resources, and engagement opportunities"
    ],
    icon: Users,
  ...
  },
  {
    ...
    bulletPoints: [
      ...
      "Findings supported targeted public health strategies, highlighting how spatial analysis can inform urban planning and resource allocation"
    ],
    icon: Map,
    color: "bg-secondary",
